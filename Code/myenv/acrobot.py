#Copied from https://github.com/Physics-aware-AI/Symplectic-ODENet
...
class AcrobotEnv(core.Env):
    ...
    **REFERENCE:**
    ...
    def __init__(self):
        ...
        self.action_space = spaces.Box(low=low_a, high=high_a, dtype=np.float64)
        self.state = None
        self.seed()
    ...
    def step(self, a):
        ...
        ivp = solve_ivp(fun=lambda t, y:self._dsdt(t, y, torque), t_span=[0, self.dt], y0=self.state, method='RK45')
